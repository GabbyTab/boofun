...
class TestGPUModule:
    ...
    def test_gpu_availability_functions(self):
        ...
        from boofun.core.gpu import is_gpu_available, is_gpu_enabled, enable_gpu
    ...
    def test_array_operations(self):
        ...
        from boofun.core.gpu import to_gpu, to_cpu, get_array_module
...
class TestGPUAccelerationModule:
    ...
    def test_accelerator_classes(self):
        ...
        from boofun.core.gpu_acceleration import (
            GPUAccelerator, CuPyAccelerator, NumbaAccelerator
        )
