...
class TestAllBuiltinFunctions:
    ...
    @pytest.mark.parametrize("func_factory,n", [
        (bf.AND, 2), (bf.AND, 3), (bf.AND, 4),
        (bf.OR, 2), (bf.OR, 3), (bf.OR, 4),
        (bf.parity, 2), (bf.parity, 3), (bf.parity, 4),
        (bf.majority, 3), (bf.majority, 5), (bf.majority, 7),
    ])
