...
class BDDNode:
    ...
    def __init__(self, var: Optional[int] = None, 
...
class BDDRepresentation(BooleanFunctionRepresentation[BDD]):
    ...
    def dump(self, data: BDD, **kwargs) -> Dict[str, Any]:
        ...
        return {
            'type': 'bdd',
            'n_vars': data.n_vars,
            'node_count': data.get_node_count()
        }
    ...
    def _shannon_expansion(self, truth_table: List[bool], var: int, n_vars: int, bdd: BDD) -> BDDNode:
        """
