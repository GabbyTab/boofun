...
QUERY_COMPLEXITY: Dict[str, Dict[str, Any]] = {
    ...
    "is_symmetric": {"safe": True, "queries": lambda n, k: 2 * k, "description": "Permutation test"},
    ...
    "estimate_fourier": {"safe": True, "queries": lambda n, k: k, "description": "Sample estimator"},
    ...
    "influences": {"safe": False, "queries": lambda n, k: n * 2**n, "description": "All inputs, all flips"},
    "degree": {"safe": False, "queries": lambda n, k: 2**n, "description": "Uses fourier"},
    "total_influence": {"safe": False, "queries": lambda n, k: n * 2**n, "description": "Uses influences"},
    ...
    "constant_test": {"safe": False, "queries": lambda n, k: 2**n, "description": "Exhaustive check"},
    "decision_tree_depth": {"safe": False, "queries": lambda n, k: 3**n, "description": "DP over subcubes"},
    "get_representation:truth_table": {"safe": False, "queries": lambda n, k: 2**n, "description": "Materialize"},
}
...
class QueryModel:
    ...
    def estimate_cost(self, operation: str, num_queries: int = 100) -> Dict[str, Any]:
        ...
        op_info = QUERY_COMPLEXITY.get(
            operation, 
            {"safe": False, "queries": lambda n, k: 2**self.n, "description": "Unknown"}
        )
